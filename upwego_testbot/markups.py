...
tasksMenu = ReplyKeyboardMarkup(resize_keyboard=True).add(btnVocabulary,
                                                          btnGrammar, btnCS, btnMain)
...
# ----- Cards markups -----
btnNewCards = KeyboardButton(text="Add a new card")
btnStudyCards = KeyboardButton(text="Study existing cards", callback_data="study_cards")
studyCards = ReplyKeyboardMarkup(resize_keyboard=True).add(btnNewCards,
                                                           btnStudyCards, btnMain)
...
feedback = InlineKeyboardMarkup().add(btnBad, btnTryAgain, btnGood, btnAwesome,
                                      btnQuitCards)
